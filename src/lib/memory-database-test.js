// Simple test file for memory-database.ts
// This file contains basic tests for the in-memory database implementation

// Import the memory database
import { getMemoryDatabase } from './memory-database.js';
